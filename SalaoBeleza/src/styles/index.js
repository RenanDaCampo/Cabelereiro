...
export const Cover = styped.ImageBackground.attrs((props) => ({
    source: {
        uri: props.Image,
    }
}))`
    ...
    margin: ${(props) => props.spacing || '0 10px 0'};
...
export const Title = styled(TitlePaper)`
    ...
    padding: ${(props) => (props.hasPadding ? '22px' : '0px')};
...
export const Text = styled(TextPaper)`
    ...
    font-family ${(props) => (props.bold ? 'Ubuntu-Bold' : 'Ubuntu-Bold')};
    margin: ${(props) => props.spacing || 0};
    padding: ${(props) => (props.hasPadding ? '20px' : '0px')};
`;
...
export const Button = styled(ButtonPaper).attrs((props) => ({
    ...
    labelStyle: {
        color: theme.colors[prop.textColor || 'light'],
        letterSpacing: 0,
    },
}))``;
